...
public class ItemServiceImpl extends AbstractServiceImpl<Item, IItemRepository> implements IItemService {
    ...
    @Override
    public List<Item> getItemByPhoneBrandIdAndTypeId(Long pId, Long Iid) {
        return iItemRepository.findItemByPhoneBrandIdAndItemTypeId(pId, Iid);
    }

    @Override
    public List<Item> getItemByPhoneBrandId(Long pId) {
        return iItemRepository.findItemByPhoneBrandId(pId);
    }
